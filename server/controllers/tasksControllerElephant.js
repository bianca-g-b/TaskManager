...
// Write function that will get all tasks from Supabase
export async function getAllTasksFromSupabase(req, res) {
    try {
        const tasks = await tasksModel.getAllTasksFromSupabase();
        return res.json(tasks)
    } catch (error) {
...
// Write function that will get all tasks from Supabase using pool
export async function getAllTasksFromSupabaseUsingPool(req, res) {
    try {
        const tasks = await tasksModel.getAllTasksFromSupabaseUsingPool();
        return res.json(tasks)
    } catch (error) {
        return res.json({error: error.message})
    }
